...
//<td>item</td>
export const StatusCell: React.FC<StatusCellProps> = ({ cell, children, variant, border=true }) => {
  ...
  return (<td className={` ${border ? 'border-b border-[#eee]' : 'border-none'}  py-5 px-4 dark:border-strokedark`}>
    {val}
  </td>)
}
