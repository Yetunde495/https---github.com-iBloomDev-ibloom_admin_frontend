...
const Stepper: React.FC<StepperProps> = ({ steps, activeStep, setActiveStep }) => {
  const handleClick = (index: number) => {
    setActiveStep(index);
  };
  return (
    <div className="flex flex-col w-full flex-wrap justify-between items-center py-3.5 gap-y-4">
