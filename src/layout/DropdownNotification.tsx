  ...
  return (
    <li className="relative">
      <Link
        ...
        to="#"
        className="relative flex h-8.5 w-8.5 items-center justify-center rounded-lg text-slate-500 border-[0.5px] border-stroke bg-white hover:text-primary dark:border-strokedark dark:bg-meta-4 dark:text-white"
      >
